...
class OrgView(View):
    ...
    def get(self,request):
        ...
        #筛选城市
        city_id = request.GET.get('city', "")#从request中获取city参数
        if city_id:
...
class AddUserAskView(View):
    ...
    def post(self, request):
        ...
        if userask_form.is_valid():
            user_ask = userask_form.save(commit=True)#完成model的实例化并保存
...
class TeacherListView(View):
    ...
    def get(self,request):
        ...
        search_keywords = request.GET.get("keywords","")
        if search_keywords:
            all_teachers = all_teachers.filter(Q(name__contains=search_keywords)|Q(work_company__contains=search_keywords)|Q(work_position__contains=search_keywords))
